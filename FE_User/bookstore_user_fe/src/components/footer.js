...
import logo_footer from "../screen/css/images/paymenticon.png";
import logo from "../screen/css/images/logo.png";

export default function FooterPage(){
    return(
        <div id="tg-footer" className="tg-footer tg-haslayout">
						...
						<div className="tg-threecolumns">
							<div className="col-xs-12 col-sm-6 col-md-4 col-lg-4">
								<div className="tg-footercol">
									<strong className="tg-logo"><a href="javascript:void(0);"><img src={logo} alt="image description"/></a></strong>
			...
			<div className="tg-footerbar">
				...
				<div className="container">
					<div className="row">
						<div className="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							<span className="tg-paymenttype"><img src={logo_footer} alt="image description"/></span>
							<span className="tg-copyright">2023 All Rights Reserved By &copy; Ducanh</span>
						</div>
					</div>
				</div>
			</div>
